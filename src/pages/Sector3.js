    ...
    return (
        <Background>
            ...
            <TextBlock>
                ...
                농업 스타트업단지는 청년농업인의 영농기반을 마련하여 농촌에 안정적 으로 정착하고 농지확보 어려움을 해결하고자, 저활용 농지(유휴농지, 국·공유지 및 매입비축농지)를 활용해 특수작물 재배
                및 시설영농이 가 능하도록 10~20ha 규모의 단지에 생산기반시설을 구축한 다음, 인접 시 군의 청년농업인에게 임대·분양<strong>(1인당 상한 규모 설정)</strong>하는 것을
                목적 으로 설계되었습니다.
                다만, 논에서의 벼재배는 해당 사업의 지원대상으 로 고려하지 않고 있습니다. 아래의 설문문항을 통해 농업 스타트업단지 에 대한 귀하의 견해를 듣고자 합니다.
            </TextBlock>
            ...
            <QuestionBlock
                ...
                <FormControl fullWidth>
                    ...
                    <Grid strict gridColumnProperty={'5fr 0.5fr 5fr'}>
                        <CenterBox start>4. 인력 기술 및 정보 획득 용이</CenterBox>
                        <div></div>
                    ...
                    <Grid strict gridColumnProperty={'5fr 0.5fr 5fr'}>
                        <CenterBox start>11. 용이한 용·배수 여견</CenterBox>
                        <div></div>
                ...
                <>
                    ...
                    <QuestionBlock title={
                        <>
                            ...
                            <br/>
                            <strong><em>※ 아래 4개 질문(재배희망작물, 영농형태, 영농계획 규모, 스마트팜 여부)에 모두 답변해주세요.</em></strong>
                        </>}
                    >
                            ...
                            <FormControl fullWidth>
                                <RadioGroup onChange={handleS3b4b2_2}>
                                    <Grid gridColumnProperty={"repeat(4,1fr)"}>
                                        ...
                                        <FormControlLabel value='3' control={<Radio/>} label='단동형 비닐하우스 시설원예'/>
                                        <FormControlLabel value='4' control={<Radio/>} label='연동형 비닐하우스 시설원예'/>
                                    </Grid>
                                </RadioGroup>
                            </FormControl>
                        </QuestionBlock>
                ...
                <FormControl fullWidth>
                    <RadioGroup onChange={handleS3b5}>
                        <Grid gridColumnProperty={"repeat(2,1fr)"}>
                            ...
                            <Stack direction='row'>
                                <FormControlLabel control={<Radio/>} label='7. 기타'/>
            ...
            <QuestionBlock title={<div>
                3-7. 스타트업 단지 내 아래와 같은 단동형·연동형 비닐하우스를 설치할 수 있다면(철골 유리·경질 판·비닐 온실은 설치 불가), 자부담 비율은 어느 정도가 적정하다고 생각하십니까?</div>}>
                <FormControl fullWidth>
