            ...
            >
...

                {
                    s3b1Data.map((element, idx) => (
                        <>
                            <Select value={element[0]} onChange={(e) => handleS3b1(e, idx, 0)}>
...

            {
                ...
                <>
                    ...
                    >
...

                        {
                            s3b3b1Data.map((element, idx) => (
                                <>
                                    <Select value={element[0]} onChange={(e) => handleS3b3b1(e, idx, 0)}>
                                        <MenuItem value={'1'}>논</MenuItem>
                                        <MenuItem value={'2'}>밭</MenuItem>
                                        <MenuItem value={'3'}>과수원</MenuItem>
                                        <MenuItem value={'4'}>시설원예</MenuItem>
                    ...
                    <QuestionBlock title={<div>3-3-2. 귀하께서는 영농규모(농지 또는 축사 면적)를 확대하시려는 이유는 무엇입니까?</div>}
                                   ...
                                   onChange={handleS3b3b2}
                    >
                        <CenterBox padding={20}>1순위 : <strong>{s3b3b2_1}</strong></CenterBox>
                        <CenterBox padding={20}>2순위 : <strong>{s3b3b2_2}</strong></CenterBox>

                        <FormControlLabel control={<Checkbox name='1' checked={s3b3b2Data[1]} onChange={handleS3b3b2}/>}
                                          label='1. 영농소득을 늘리기 위해서'/>
                        <FormControlLabel control={<Checkbox name='2' checked={s3b3b2Data[2]} onChange={handleS3b3b2}/>}
                                          label='2. 주 작목의 생산규모를 늘리기 위해서'/>
                        <FormControlLabel control={<Checkbox name='3' checked={s3b3b2Data[3]} onChange={handleS3b3b2}/>}
                                          label='3. 생산 품목을 다양화하기 위해서'/>
                        <FormControlLabel control={<Checkbox name='4' checked={s3b3b2Data[4]} onChange={handleS3b3b2}/>}
                                          label='4. 자산가치로써 농지를 확보하기 위해서'/>
                        <FormControlLabel control={<Checkbox name='5' checked={s3b3b2Data[5]} onChange={handleS3b3b2}/>}
                                          label='5. 농기계-설비 이용률을 높이기 위해서'/>
                        <FormControlLabel control={<Checkbox name='6' checked={s3b3b2Data[6]} onChange={handleS3b3b2}/>}
                    ...
                    >
...

                        {
                            s3b4Data.map((element, idx) => (
                                <>
                                    <Select value={element[0]} onChange={(e) => handleS3b4(e, idx, 0)}>
                                        <MenuItem value={'1'}>논</MenuItem>
                                        <MenuItem value={'2'}>밭</MenuItem>
                                        <MenuItem value={'3'}>과수원</MenuItem>
                                        <MenuItem value={'4'}>시설원예</MenuItem>
                        ...
                        <>
                            ...
                            >
                                ...
                                <Stack direction='row'>
                                    ...
                                    <TextField value={s3b7b1_Etc5} onChange={(e) => setS3b7b1_Etc5(e.target.value)}/>
                                </Stack>
                            </QuestionBlock>
                            ...
                            >
                                ...
                                <FormControlLabel
                                    control={<Checkbox name='1' checked={s3b7b2Data[1]} onChange={handleS3b7b2}/>}
                                    label='1. 담보 확보'/>
                                <FormControlLabel
                                    control={<Checkbox name='2' checked={s3b7b2Data[2]} onChange={handleS3b7b2}/>}
                                    label='2. 자부담 여력 없음'/>
                                <FormControlLabel
                                    control={<Checkbox name='3' checked={s3b7b2Data[3]} onChange={handleS3b7b2}/>}
                                    label='3. 금리가 비싸다'/>
                                <FormControlLabel
                                    control={<Checkbox name='4' checked={s3b7b2Data[4]} onChange={handleS3b7b2}/>}
                                    label='4. 상환기값이 짧다'/>
                                <FormControlLabel
                                    control={<Checkbox name='5' checked={s3b7b2Data[5]} onChange={handleS3b7b2}/>}
                                    label='5. 융자액이 적다'/>
                                <FormControlLabel
                                    control={<Checkbox name='6' checked={s3b7b2Data[6]} onChange={handleS3b7b2}/>}
                                    label='6, 복잡한 서류 절차'/>
                                <FormControlLabel
                                    control={<Checkbox name='7' checked={s3b7b2Data[7]} onChange={handleS3b7b2}/>}
                                    label='7. 정책자금의 중복 지원 불가'/>
                                <FormControlLabel
                                    control={<Checkbox name='8' checked={s3b7b2Data[8]} onChange={handleS3b7b2}/>}
                                    label='8. 자기자본 풍부'/>
                                <Stack direction='row'>
                                    <FormControlLabel
